...
<body class="bg-white text-slate-800">
    ...
    @php
        ...
        $categories = \App\Models\Project::where('is_active', true)
    ...
    <section class="relative w-full overflow-hidden" style="height:50vh; min-height:360px;">
        ...
        <div class="relative z-10 h-full flex items-center justify-center">
            <div class="max-w-3xl mx-auto px-4 text-center text-white">
                <span
                    class="inline-block bg-gold text-primary text-xs font-bold uppercase tracking-wider px-3 py-1 rounded-full mb-4">Portfolio</span>
                <h1 class="text-3xl md:text-5xl font-extrabold leading-tight mb-4 drop-shadow-lg">Our Projects</h1>
                <p class="text-lg text-slate-100 leading-relaxed drop-shadow max-w-2xl mx-auto">Explore a selection of
                    industrial projects we have successfully delivered for our clients.</p>
            </div>
        </div>
    ...
    @if ($categories->isNotEmpty())
        <div class="bg-white border-b border-slate-100 sticky top-16 z-30">
            <div class="max-w-7xl mx-auto px-4 py-4 flex flex-wrap gap-2 justify-center" id="categoryFilter">
                <button class="filter-btn active px-4 py-1.5 rounded-full text-sm font-medium transition-all"
                    data-cat="all">All</button>
                @foreach ($categories as $cat)
                    <button class="filter-btn px-4 py-1.5 rounded-full text-sm font-medium transition-all"
                            ...
                            <div class="h-56 relative overflow-hidden">
                                ...
                                @else
                                    <div class="w-full h-full flex items-center justify-center"
                                        ...
                                        <i
                                            class="bi {{ $project->icon ?: 'bi-kanban' }} text-white/90 text-7xl group-hover:scale-110 transition-transform duration-500"></i>
                                    </div>
                                @endif
                                @if ($project->category)
                                    <span
