    ...
    <main class="flex-grow flex flex-col md:flex-row pt-12 md:pt-14 overflow-hidden">
        ...
        <div
            ...
            <div class="w-full max-w-[400px]">
                ...
                <form class="space-y-md" id="resetForm" onsubmit="return false">
                    @csrf
                    ...
                    <div class="space-y-base">
                        ...
                        <div class="relative">
                            ...
                            <button
                                ...
                                onclick="togglePassword('password', 'passwordIcon')" type="button">
                    ...
                    <div class="space-y-base">
                        ...
                        <div class="relative">
                            ...
                            <button
                                class="absolute right-xs top-1/2 -translate-y-1/2 w-[40px] h-[40px] flex items-center justify-center text-on-surface-variant hover:text-primary transition-colors"
                                onclick="togglePassword('password_confirmation', 'confirmPasswordIcon')" type="button">
                                <span class="material-symbols-outlined text-[20px]" data-icon="visibility"
                                    id="confirmPasswordIcon">visibility</span>
                            </button>
                        </div>
                    </div>
