        ...
        <div class="hidden md:block md:w-1/2 lg:w-[60%] relative bg-primary-container overflow-hidden">
            ...
            <div class="absolute bottom-xl left-xl z-20 text-white max-w-lg">
                ...
                <p class="font-body-md opacity-90">
                    Manage and update the content of the company's landing page — including
                    products, inquiries, and business information — in the industrial valve
                    &amp; actuator distribution sector.
                </p>
            </div>
        ...
        <div
            ...
            <div class="w-full max-w-[400px]">
                <div class="mb-lg text-center md:text-left">
                    ...
                    <h1 class="font-headline-lg-mobile md:text-headline-lg text-primary mb-xs">Welcome</h1>
                    <p class="font-body-sm text-body-sm text-on-surface-variant">Please sign in to your account</p>
                </div>
                <form class="space-y-md" id="loginForm" onsubmit="return false">
                    @csrf
                    ...
                    <div class="flex items-center justify-between py-xs">
                        <label class="flex items-center gap-xs cursor-pointer group">
                            <input class="w-4 h-4 rounded-sm border-outline-variant text-primary focus:ring-primary/20"
                                type="checkbox" name="remember" id="remember" />
                            <span
                                class="font-label-sm text-label-sm text-on-surface-variant group-hover:text-on-surface transition-colors">Remember
                                me</span>
                        </label>
                ...
                <div class="hidden mt-md p-sm bg-error-container border border-error/20 rounded-lg flex items-center gap-xs"
                    ...
                    <p class="font-body-sm text-body-sm text-on-error-container" id="errorText">Invalid email or password.</p>
                </div>

                @if(session('success'))
                <div class="mt-md p-sm rounded-lg flex items-center gap-xs" style="background-color: #d0e1fb; border: 1px solid rgba(0, 25, 60, 0.2);">
                    <span class="material-symbols-outlined text-[20px]" style="color: #00193c;" data-icon="check_circle">check_circle</span>
                    <p class="font-body-sm text-body-sm" style="color: #00193c;">{{ session('success') }}</p>
                </div>
                @endif

                {{-- <div class="mt-xl text-center">
                    <p class="font-body-sm text-body-sm text-on-surface-variant mb-md flex items-center gap-sm">
                        <span class="h-[1px] bg-outline-variant flex-grow"></span>
                        <span>Or sign in with</span>
                        <span class="h-[1px] bg-outline-variant flex-grow"></span>
                    </p>
                    <button
                        class="w-full h-[48px] border border-outline-variant bg-white text-on-surface font-label-md text-label-md rounded-lg hover:bg-surface-container transition-all flex items-center justify-center gap-xs mb-sm">
                        <img alt="Google" class="w-5 h-5"
                            src="https://lh3.googleusercontent.com/aida-public/AB6AXuD8C5YKq21qRmfzWB2IOHaVy2UrEUMSkPL6tVp1dfN-U7cQCSU9lMjGSQb6LUkRYqbitUsyP0gzzMBYJBYyi_3vz_h9aaFQ8ciMIoZ4Jd8j2WRQ90Q6v5EsQiT3Fmffq8t--muDmu3rFQnGCz9F0JpvoDaj7XEbc3CitHp6B085EboWO-xZ1kIRFuaTd0K0BOGZYw-DVuyHEGmLrc7qhIVcmZ5zGqKAVdpBQWerm27TxMuR_sUhQaDf" />
                        Single Sign-On (SSO)
                    </button>
                </div> --}}
            </div>
...
<div class="grid grid-cols-1 md:grid-cols-12 gap-6 items-center">
            ...
            <div class="md:col-span-12 text-center md:text-left">
                <p class="font-body-sm text-body-sm text-primary font-bold mb-1">
                    {{ config('app.name') }}
                </p>

                <p class="font-body-sm text-body-sm text-on-surface-variant">
                    &copy; {{ date('Y') }} All rights reserved. This system is developed to manage
                    the content of the company's landing page in the industrial valve &amp;
                    actuator distribution sector.
                </p>
            </div>
    ...
    <script src="{{ asset('auth_assets/script.js') }}"></script>
</body>
