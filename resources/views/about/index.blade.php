...
<head>
    ...
    <style>
        ...
        .about-images-wrap.in-view .about-img-overlay {
            animation: fadeInRight 0.8s ease 0.35s forwards, floatY2 6s ease-in-out 1.15s infinite;
        }
...
<body class="bg-white text-slate-800">
    ...
    <section id="about-content" class="py-16">
        <div class="max-w-5xl mx-auto px-4">
            <p class="text-slate-600 leading-relaxed text-base md:text-lg mb-6">
                {{ $settings['about_subtitle'] ?? '' }}</p>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-10">
                    @foreach ($bullets as $bullet)
                        <div class="flex items-start gap-3 p-4 bg-slate-50 rounded-xl border border-slate-100">
                            <div
                                class="inline-flex items-center justify-center w-8 h-8 rounded-full bg-primary/10 shrink-0">
