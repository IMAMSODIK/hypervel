    ...
    <section class="relative w-full overflow-hidden" style="height:60vh; min-height:420px;">
        ...
        <div class="relative z-10 h-full flex items-center justify-center">
            <div class="max-w-3xl mx-auto px-4 text-center text-white">
                <span
                    class="inline-block bg-gold text-primary text-xs font-bold uppercase tracking-wider px-3 py-1 rounded-full mb-4">Product</span>
                <h1 class="text-3xl md:text-5xl font-extrabold leading-tight mb-4 drop-shadow-lg">{{ $product->title }}
                </h1>
                        ...
                        <div class="flex gap-3 mt-4 overflow-x-auto pb-2" id="galleryThumbs">
                            @if ($product->featured_image)
                                <button
                                    ...
                                    data-src="{{ $product->featured_image_url }}">
                            ...
                            @foreach ($product->images as $img)
                                <button
                                    class="gallery-thumb shrink-0 rounded-lg overflow-hidden border-2 border-transparent @if (!$product->featured_image && $loop->first) active @endif"
